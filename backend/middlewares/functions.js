...
module.exports = function () {
	...
	this.getipfromRequest = function (req) {
		if (req.rawHeaders.indexOf("X-Forwarded-For") == -1) return "";
		return req.rawHeaders[
			req.rawHeaders.indexOf("X-Forwarded-For") + 1
		].split(",")[0];
	};
	...
	this.getVerifyEmailTemplate = function (user_full_name, Otp) {
        return `
        <!DOCTYPE html>
        <html lang="en">
        <head>
	...
	this.getForgotPasswordEmailTemplate = function (customerName, resetLink) {
		return `
		<!DOCTYPE html>
		<html lang="en">
		<head>
		...
		<body>
			 ...
			 <div class="email-container">
            <div class="email-header">
                <h1>PathWay Academy</h1>
            </div>
            <div class="email-body">
                <p>Dear ${customerName},</p>
                <p>We received a request to reset your password for your <strong>PathWay Academy</strong> account.</p>
            ...
            <div class="email-footer">
                ...
                <p>1. The password reset link is valid for 10 minutes.</p>
                <p>2. PathWay Academy is not responsible for any unauthorized use of your account.</p>
                <p>3. If you face any issues, please contact <a href="mailto:support@PathWay Academy.com">support@PathWay Academy.com</a>.</p>
                <p>&copy; 2024 PathWay Academy. All rights reserved.</p>
            </div>
        </div>
	...
	this.getSuccessEmailTemplate = function (customerName) {
		return `
		<!DOCTYPE html>
		<html lang="en">
		<head>
		...
		<body>
			...
			<div class="email-container">
            <div class="email-header">
                <h1>Welcome to PathWay Academy! 🌟</h1>
            </div>
            <div class="email-body">
                <p>Dear ${customerName},</p>
                <p>Thank you for joining <strong>PathWay Academy</strong>! We're thrilled to have you with us.</p>
                <p>At PathWay Academy, we offer eco-friendly and reliable cleaning solutions for your home and business. Our team of experts ensures your space shines with our professional services, including deep cleaning, kitchen, bathroom, sofa, and carpet cleaning.</p>
                <p>We care about the environment, so we use safe, eco-friendly products that are good for both your home and the planet.</p>
                <div class="success-message">Your registration was successful!</div>
                <p>If you need any assistance, feel free to contact us anytime.</p>
            </div>

            <div class="email-footer">
                <p>Need help? Contact us at <a href="mailto:support@PathWay Academy.com">support@PathWay Academy.com</a></p>
                <p>&copy; 2024 PathWay Academy. All rights reserved.</p>
            </div>
        </div>
	...
	this.getLoginSuccessEmailTemplate = function (customerName) {
		return `
		<!DOCTYPE html>
		<html lang="en">
		<head>
		...
		<body>
            ...
            <div class="email-body">
                <p>Dear ${customerName},</p>
                <div class="success-message">Your login was successful!</div>
                <p>You can now enjoy seamless shopping experiences with us. Explore exclusive deals and offers available just for you.</p>
	...
	this.getContactFormEmailTemplate = function (customerName, customerEmail, customerSubject, customerMessage) {
		return `
		<!DOCTYPE html>
		<html lang="en">
		<head>
		...
		<body>
			...
			<div class="email-container">
				...
				<div class="email-body">
					...
					<p>A new contact form has been submitted on the <strong>PathWay Academy</strong> website. Below are the details:</p>
				...
				<div class="email-footer">
					<p>Need help? Contact us at <a href="mailto:support@PathWay Academy.com">support@PathWay Academy.com</a>.</p>
					<p>&copy; 2024 support@PathWay Academy.com. All rights reserved.</p>
				</div>
			</div>
	...
	this.getDocumentActivationEmailTemplate = function (customerName) {
		return `
		<!DOCTYPE html>
		<html lang="en">
		<head>
		...
		<body>
			...
			<div class="email-container">
				<div class="email-header">
					<h1>Document Activation Successful ✅</h1>
				</div>
				<div class="email-body">
					<p>Dear ${customerName},</p>
					<p>We are pleased to inform you that your document <strong>PAn,Aadhar and Bank PassBook</strong> has been successfully activated.</p>
					<p>Your document is now verified and approved. You can proceed with the next steps in our system without any issues.</p>
					<div class="success-message">Your document is now active!</div>
